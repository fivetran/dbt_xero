...
- Removed the dependency on the `fivetran/xero_source` package.
  ...
  - Update any xero_source-scoped variables to be scoped to only under this package. See the [README](https://github.com/fivetran/dbt_xero/blob/main/README.md) for how to configure the build schema of staging models.
