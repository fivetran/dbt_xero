...
with journal_cash_line_has_tracking as (

    select *
    from {{ ref('stg_xero__journal_cash_line_has_tracking_category') }}
...
), journal_cash_tracking as (

    select
        journal_cash_line_has_tracking.journal_id,
        journal_cash_line_has_tracking.journal_line_id,
        journal_cash_line_has_tracking.source_relation,
        tracking_categories_with_options.tracking_category_name,
        tracking_categories_with_options.tracking_option_name
    from journal_cash_line_has_tracking

    left join tracking_categories_with_options
        on journal_cash_line_has_tracking.tracking_category_id = tracking_categories_with_options.tracking_category_id
        and journal_cash_line_has_tracking.tracking_category_option_id = tracking_categories_with_options.tracking_option_id
        and journal_cash_line_has_tracking.source_relation = tracking_categories_with_options.source_relation
),
